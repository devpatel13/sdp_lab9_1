...
class Quotecard extends StatelessWidget {
  //Quote quote; //in stateless widget variables are not allowed
  final Quote quote;
...
/*import 'package:flutter/material.dart';
import 'package:sdp_lab_9_ce085/quote.dart'; // Absolute path
...
*/
  List<Quote> quotes = [
    Quote(text: 'I remember you was conflicted misusing your influence',author:
    'Kendrick Lamar'),
    Quote(author: 'Jermaine Cole', text: 'To appreciate the sun you got to know'
        'what rain is'),
    Quote(text: 'Before judging a person, walk a mile in his shoes',author:
    'Marshall Mathers'),
  ];
/*
Widget quoteTemplate(quote){
